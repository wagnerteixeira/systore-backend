...
namespace Systore.Data.Repositories
{
    public class ClientRepository : BaseRepository<Client>, IClientRepository
    {
        ...
        private async Task<string> Validate(Client entity, bool edit)
        {
            ...
            if (_client != null)
                validations += $"J� existe um cliente com o CPF {_client.Cpf}, {_client.Name}|";
            if (entity.DateOfBirth > DateTime.Now)
                validations += $"Data de anivers�rio {(entity.DateOfBirth.HasValue ? entity.DateOfBirth?.ToString("dd/MM/yyyy") : "")} deve ser menor que a data atual{DateTime.Now.ToString("dd/MM/yyyy")}|";
